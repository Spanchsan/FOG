...
public class FindHard extends ApplicationAdapter implements Screen {
    ...
    public void render(float delta) {
        ...
        if (timer <= 0) {
            if (targetDone) {
                game.setScreen(new WinScreen(game, (int) looted, 2, (int) looted, 2));
                dispose();
            } else {
                game.setScreen(new FailScreen(game, (int) looted, 2, (int) looted, 2));
                dispose();
            }
        }
